  ...
  return (
    <section>
      <nav
        ref={navRef}
        className={cls(
          "z-10 fixed w-full p-3 py-4 text-zinc-50  flex justify-between items-center "
        )}
      >
        <div
          className={cls(
          ...
          <AnimatePresence>
            {profileNav ? (
              <motion.div
                ...
                animate="animate"
                exit="exit"
                className="z-10 absolute top-8 w-20 h-20 right-6 rounded-3xl dark:bg-gray-700 rounded-tr-none origin-top bg-zinc-100 text-zinc-800 shadow-black shadow-sm dark:text-zinc-50"
              >
